...
export const Graveyard = () => (
    <div className="border-muted-foreground/20 mx-6.25 mt-12.5 max-h-72 overflow-hidden rounded-t-lg border border-b-4 border-b-transparent bg-neutral-50 px-2 py-4 shadow">
